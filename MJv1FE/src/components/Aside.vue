    ...
    <el-row>
        <el-col :span="24">
            <el-menu active-text-color="#337ecc" background-color="#ffffff" @select="handleSelect" text-color="#606266"
                ...
                <el-menu-item index="roomReservation" v-if="userStore.isCustomer">
                    <el-icon><House /></el-icon>
                    <span>预订房间</span>
                </el-menu-item>
                <el-menu-item index="reservationManage" v-if="userStore.isCustomer">
                    <el-icon><More /></el-icon>
                    <span>预订管理</span>
                </el-menu-item>
                <el-menu-item index="onlineService" v-if="userStore.isCustomer">
                    <el-icon><Service /></el-icon>
                    <span>在线客服</span>
                </el-menu-item>
                <el-menu-item index="reviewsFeedback" v-if="userStore.isCustomer">
