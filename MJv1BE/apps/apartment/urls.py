...
urlpatterns = [
    ...
    path('reservations/<int:user_id>/', views.get_customer_reservations, name='reservation_history'),
    path('customer/cancel_reserve/', views.customer_cancel_reserve, name='cancel_customer_reservation'),
]
